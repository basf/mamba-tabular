...
class AutoIntRegressor(SklearnBaseRegressor):
    __doc__ = generate_docstring(
        ...
        model_description="""
        Multi-Layer Perceptron regressor. This class extends the SklearnBaseRegressor class and uses the AutoInt model
        with the default AutoInt configuration.
        """,
        examples="""
...
class AutoIntClassifier(SklearnBaseClassifier):
    __doc__ = generate_docstring(
        DefaultAutoIntConfig,
        model_description="""
        Multi-Layer Perceptron classifier This class extends the SklearnBaseClassifier class and uses the AutoInt model
        with the default AutoInt configuration.
        """,
        examples="""
...
class AutoIntLSS(SklearnBaseLSS):
    __doc__ = generate_docstring(
        DefaultAutoIntConfig,
        model_description="""
        Multi-Layer Perceptron for distributional regression. This class extends the SklearnBaseLSS class and uses the AutoInt model
        with the default AutoInt configuration.
        """,
        examples="""
