...
from ..base_models.basis_expansion_fttransformer import BasisFTTransformer
from ..configs.fttransformer_config import DefaultFTTransformerConfig


class BasisFTTransformerRegressor(SklearnBaseRegressor):
    """
    ...
    def __init__(self, **kwargs):
        super().__init__(
            model=BasisFTTransformer, config=DefaultFTTransformerConfig, **kwargs
        )


class BasisFTTransformerClassifier(SklearnBaseClassifier):
    """
...
class BasisFTTransformerLSS(SklearnBaseLSS):
    """
