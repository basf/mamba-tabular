...
class TabulaRNNForecast(SklearnBaseTimeSeriesForecaster):
    """
    RNN forecast. This class extends the SklearnBaseForecast class and uses the TabulaRNN model
    with the default TabulaRNN configuration.

    The accepted arguments to the TabulaRNNForecast class include both the attributes in the DefaultTabulaRNNConfig dataclass
