...
class MambularForecast(SklearnBaseTimeSeriesForecaster):
    """
    Mambular Forecast. This class extends the SklearnBaseForecast class and uses the Mambular model
    with the default Mambular configuration.

    The accepted arguments to the MambularForecast class include both the attributes in the DefaultMambularConfig dataclass
    ...
    Notes
    -----
    - The accepted arguments to the MambularForecast class are the same as the attributes in the DefaultMambularConfig dataclass.
    - MambularForecast uses SklearnBaseForecast as the parent class. The methods for fitting, predicting, and evaluating the model are inherited from the parent class. Please refer to the parent class for more information.

    See Also
    --------
    mambular.models.SklearnBaseForecast : The parent class for MambularForecast.

    Examples
    --------
    >>> from mambular.models import MambularForecast
    >>> model = MambularForecast(d_model=64, n_layers=8)
